...
public class LocomotionMain {
	...
	public static ResourceLocation makeIdentifier(String location) {
	...
	private static void registerAnimators() {
		...
		// Player third person is intentionally not registered. Fresh Animations + EMF own that model.
		// Registering EntityType.PLAYER would store a locomotion pose and clobber player.jem.
