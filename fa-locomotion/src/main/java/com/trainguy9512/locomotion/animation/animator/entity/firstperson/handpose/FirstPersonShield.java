...
public class FirstPersonShield {
    ...
    public static String getShieldCacheResourceLocation(InteractionHand hand) {
    ...
    public static PoseFunction<LocalSpacePose> getShieldCachedPoseFunction(
        ...
        String shieldCacheResourceLocation = getShieldCacheResourceLocation(hand);
        return cachedPoseContainer.getOrThrow(shieldCacheResourceLocation);
    }
    ...
    public static PoseFunction<LocalSpacePose> constructShieldPoseFunction(
        ...
        String shieldCacheResourceLocation = getShieldCacheResourceLocation(hand);
        cachedPoseContainer.register(shieldCacheResourceLocation, shieldStateMachine, true);
