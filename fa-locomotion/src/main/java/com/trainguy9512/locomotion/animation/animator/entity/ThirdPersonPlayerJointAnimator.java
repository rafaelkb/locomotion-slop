...
public class ThirdPersonPlayerJointAnimator implements EntityJointAnimator<Player> {
    @Override
    public void postProcessModelParts(EntityModel<?> entityModel) {

    }

    @Override
    public ResourceLocation getJointSkeleton() {
        return ResourceLocation.fromNamespaceAndPath(LocomotionMain.MOD_ID, "skeletons/entity/player/third_person.json");
    }
