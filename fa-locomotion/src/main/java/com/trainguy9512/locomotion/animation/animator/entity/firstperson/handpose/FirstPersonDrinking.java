...
public class FirstPersonDrinking {
    ...
    public static void updateConsumptionSpeed(PoseTickEvaluationContext context, InteractionHand hand) {
        ...
        // Potions and milk have no food component on 1.21.1. Their use time is 32 ticks.
        float seconds = food != null ? food.eatDurationTicks() / 20.0f : 1.6f;
        float speed = 1f / Math.max(seconds, 0.1f);
