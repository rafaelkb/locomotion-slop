 ...
 *
 * @param identifier                        ResourceLocation for this montage configuration.
...
public record MontageConfiguration(
        ...
        boolean isAdditive,
        Function<DriverGetter, ResourceLocation> additiveBasePoseProvider,
    ...
    public static class Builder {
        ...
        private Function<DriverGetter, ResourceLocation> additiveBasePoseProvider;
         ...
         * @param slotResourceLocation        String slot identifier
         */
        public Builder playsInSlot(String slotResourceLocation) {
            this.slots.clear();
            this.slots.add(slotResourceLocation);
            return this;
        }

        /**
         * Sets a list of slot identifiers that the animation will play in.
         * @param slotResourceLocations       String slot identifiers
         */
        public Builder playsInSlots(String... slotResourceLocations) {
            this.slots.clear();
            this.slots.addAll(List.of(slotResourceLocations));
            return this;
        }
         ...
         * @param timeMarkerResourceLocation  String identifier for the time marker, pointing to the associated time marker in the sequence file.
         * @param binding               Event to fire every time this time marker is passed when the sequence player is playing.
         */
        public Builder bindToTimeMarker(String timeMarkerResourceLocation, Consumer<PoseTickEvaluationContext> binding) {
            this.timeMarkerBindings.computeIfPresent(timeMarkerResourceLocation, (identifier, existingBinding) -> existingBinding.andThen(binding));
            this.timeMarkerBindings.putIfAbsent(timeMarkerResourceLocation, binding);
            return this;
        }
