...
//            return FirstPersonHandPoses.getOrThrowFromResourceLocation(FirstPersonHandPoses.EMPTY_OFF_HAND).getLowerStateResourceLocation();
//        }

        ResourceLocation handPoseResourceLocation = driverGetter.getDriverValue(FirstPersonDrivers.getHandPoseDriver(hand));
        FirstPersonHandPoses.HandPoseDefinition definition = FirstPersonHandPoses.getOrThrowFromResourceLocation(handPoseResourceLocation);
        return definition.stateResourceLocation();
    }
    ...
    public static PoseFunction<LocalSpacePose> constructPoseFunction(CachedPoseContainer cachedPoseContainer, InteractionHand hand) {
        ...
        for (ResourceLocation handPoseResourceLocation : FirstPersonHandPoses.getRegisteredHandPoseDefinitions()) {
            FirstPersonHandPoses.HandPoseDefinition handPose = FirstPersonHandPoses.getOrThrowFromResourceLocation(handPoseResourceLocation);
            defineStatesForHandPose(cachedPoseContainer, hand, stateMachineBuilder, fromLowerAliasBuilder, handPoseResourceLocation, handPose);
        }
    ...
    public static ResourceLocation getCurrentBasePoseForAdditive(PoseCalculationContext context, InteractionHand hand) {
        ResourceLocation currentHandPoseResourceLocation = context.getDriverValue(FirstPersonDrivers.getHandPoseDriver(hand));
        FirstPersonHandPoses.HandPoseDefinition definition = FirstPersonHandPoses.getOrThrowFromResourceLocation(currentHandPoseResourceLocation);
    ...
    private static boolean shouldChooseThisHandPose(
            ...
            ResourceLocation handPoseResourceLocation,
            InteractionHand hand
    ) {
        ItemStack currentItemStack = context.getDriverValue(FirstPersonDrivers.getItemDriver(hand));
        ResourceLocation handPoseFromCurrentItemStack = FirstPersonHandPoses.testForNextHandPose(currentItemStack, hand);
        return handPoseResourceLocation == handPoseFromCurrentItemStack;
    }
    ...
    private static boolean shouldTransitionToThisRaiseState(
        ...
        return shouldChooseThisHandPose(context, handPoseResourceLocation, hand);
    }
    ...
    public static void defineStatesForHandPose(
        ...
        String poseState = handPose.stateResourceLocation();
        String lowerState = handPose.getLowerStateResourceLocation();
        String raiseState = handPose.getRaiseStateResourceLocation();
        ...
        fromLowerAliasBuilder
                ...
                .addOutboundTransition(StateTransition.builder(raiseState)
                        ...
                        .isTakenIfTrue(context -> shouldTransitionToThisRaiseState(context, handPoseResourceLocation, hand))
                        .bindToOnTransitionTaken(context -> FirstPersonDrivers.updateRenderedItemIfNoTwoHandOverrides(context, hand))
                        .bindToOnTransitionTaken(context -> clearMontagesInAttackSlot(context, hand))
                        .build())
                .addOutboundTransition(StateTransition.builder(poseState)
                        .setTiming(Transition.INSTANT)
                        .isTakenIfTrue(context -> shouldSkipStraightToPoseStateForAttack(context, handPoseResourceLocation, hand))
                        .bindToOnTransitionTaken(context -> FirstPersonDrivers.updateRenderedItemIfNoTwoHandOverrides(context, hand))
                        .build());;
    }

    public static void defineExtraStates(StateMachineFunction.Builder stateMachineBuilder, InteractionHand hand) {
        FirstPersonHandPoses.HandPoseDefinition emptyHandPose = FirstPersonHandPoses.getOrThrowFromResourceLocation(FirstPersonHandPoses.getEmptyHandPose(hand));
        ...
        stateMachineBuilder.defineState(StateDefinition.builder(HAND_POSE_DROPPING_LAST_ITEM_STATE, dropLastItemPoseFunction)
                ...
                .defineState(StateDefinition.builder(HAND_POSE_THROWING_TRIDENT_STATE, throwingTridentPoseFunction)
                        .addOutboundTransition(StateTransition.builder(emptyHandPose.getRaiseStateResourceLocation())
                ...
                .addStateAlias(StateAlias.builder(Set.of(
                        ...
                        .addOutboundTransition(StateTransition.builder(emptyHandPose.stateResourceLocation())
