...
public class FirstPersonAttackAnimations {
    ...
    private static final Map<ResourceLocation, AttackAnimationRule> ATTACK_ANIMATION_RULES_BY_IDENTIFIER = Maps.newHashMap();

    public static ResourceLocation register(ResourceLocation identifier, AttackAnimationRule rule) {
...
//            .build());
    ...
    public static void tryPlayingAttackAnimation(DriverGetter dataContainer, MontageManager montageManager) {
        ...
        Map<ResourceLocation, AttackAnimationRule> sortedAttackAnimationRules = ATTACK_ANIMATION_RULES_BY_IDENTIFIER.entrySet()
                .stream()
        ...
        for (ResourceLocation ruleResourceLocation : sortedAttackAnimationRules.keySet()) {
            AttackAnimationRule rule = sortedAttackAnimationRules.get(ruleResourceLocation);
